...
export const MLS_TEAMS = [
  ...
  { slug: 'los-angeles-fc', name: 'Los Angeles FC', abbreviation: 'LAFC' },
  { slug: 'inter-miami-cf', name: 'Inter Miami CF', abbreviation: 'MIA' },
  { slug: 'minnesota-united', name: 'Minnesota United', abbreviation: 'MIN' },
  ...
  { slug: 'new-york-red-bulls', name: 'New York Red Bulls', abbreviation: 'NYRB' },
  { slug: 'new-york-city-fc', name: 'New York City FC', abbreviation: 'NYCFC' },
